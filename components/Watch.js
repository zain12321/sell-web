...
function Watch() {
  return (
    ...
    <section className='bg-[#FFFFFF80] hover:shadow-2xl mt-24 mx-24'>
     ...
     <div>
        ...
        <div className='space-y-4 pr-60 pt-4'>
         ...
         <small 
            className='text-xl text-gray-500 '>Fresh Deal Every, day get it now</small><br/>
            <time className='text-xl font-bold'>270 <span className='text-[18px] text-gray-500 pr-4 pl-[1px]'>
